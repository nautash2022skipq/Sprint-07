...
def lambda_handler(event, context):
    ...
    if path == '/upload' and httpMethod == 'GET' and not queryStringParameters:
        try:
    ...
    elif path == '/upload' and httpMethod == 'GET' and queryStringParameters:
        try:
    ...
    elif path == '/upload' and httpMethod == 'POST':
        try:
    ...
    elif path == '/upload' and httpMethod == 'PUT':
        try:
            body = json.loads(event['body'])
    ...
    elif path == '/upload' and httpMethod == 'DELETE' and queryStringParameters:
        try:
            id = queryStringParameters['id']
